...
-- IMPORTANT NOTES:
-- You need to put events.csv and mortality.csv under
...
--****************Additional steps ********************************
--Load files from local to HDFS using 
--docker cp mortality.csv bigbox:/bigdata-bootcamp/sample/hive/mortality
...
-- find events for dead patients ____________________________________________________________________
